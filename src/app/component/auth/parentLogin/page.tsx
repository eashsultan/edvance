...
export default function ParentLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-violet-100 flex items-center justify-center p-4 text-black">
      <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <span className="text-xs font-medium text-indigo-500 tracking-widest mb-6 uppercase mt-0.5">
            School Management
          </span>
          <h2 className="text-xl font-bold">Parent Login Portal</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-purple-500 hover:bg-purple-600 disabled:opacity-50 text-white font-semibold py-3 rounded-2xl transition text-sm mt-2 cursor-pointer flex items-center justify-center gap-2"
          >
